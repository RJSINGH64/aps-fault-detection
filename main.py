...
if __name__=="__main__":
    try :
        ...
        print("==>"*5 , " 5th Pipeline Model Evalution Initiated Sucessfully" , "<=="*5)                             
